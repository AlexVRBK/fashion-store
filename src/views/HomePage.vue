<template>
  <div class="home">
    ...
    <div class="buttons">
      <router-link class="nav-button" to="/women"
        ><button class="home-button">Women Collection</button>
      </router-link>
      <router-link class="nav-button" to="/men"
        ><button class="home-button">Man Collection</button>
      </router-link>
    </div>
  </div>
</template>
